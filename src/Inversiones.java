public class Inversiones {
    private float inversion1 =0;
    private float inversion2 =0;
    private float inversion3 =0;

    public float getInversion1() {
        return inversion1;
    }

    public void setInversion1(float inversion1) {
    ...
    public void setInversion2(float inversion2) {
    ...
    public void setInversion3(float inversion3) {
